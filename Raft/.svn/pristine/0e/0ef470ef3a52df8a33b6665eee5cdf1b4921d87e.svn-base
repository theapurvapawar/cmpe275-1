...
public class ClusterNodeConnector {

	private final String host;
	private final int port;
	private Queue<JoinMessage> tasks;
	private boolean connected = false;

	public ClusterNodeConnector(String host, int port) {
		this.host = host;
		this.port = port;
	...
	public void sendMessage(JoinMessage msg){
		if(connected)
			tasks.offer(msg);
	}
	
	public void sendMsgStatic(JoinMessage msg){
		tasks.offer(msg);
	}
